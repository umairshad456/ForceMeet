...
const Recordings = () => {
  ...
  const fetchRecordedMeetings = async () => {
    try {
      ...
      const response = await axiosInstance.get('/api/meetings/getAllRecordedMeetings');
      console.log("Fetched data:", response.data.recordings);
    ...
    <>
      <div className="mx-auto max-w-7xl">
        <DataTable
          ...
          uniqueIdKey="_id"
          loading={loading}
          onReload={fetchRecordedMeetings}
          columns={columns}
